...
| Beneficial  | Harmful  |
| --- | --- |
| Search engines and personalized algorithms present you with infinite useful, good-faith information customized to you unique personal needs and interests |  Search engines and personalized algorithms present you with infinite emotionally-compelling, bad-faith ragebait customized to your unique personal insecurities. |
...
Unlike some addictions, which may cost money, require the addict to drive to a store, or in some other way require some effort, technology is always sitting in the addict's pocket, instantly and effortlessly accessible.

*A smoker will have a hard time quitting if there is always a pack of cigarettes in his pocket, instantly and effortlessly accessible.*

Common recommendations to reduce screen time include deleting social media apps or using built in screen time settings. However, these barriers are negligible:
- Searching for a site in a browser takes seconds
- Re-downloading an app takes seconds
- Bypassing screen time settings via a four-digit passcode takes seconds
